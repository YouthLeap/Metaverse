...
public class ColorPicker : MonoBehaviour,IPointerEnterHandler,IPointerExitHandler,IPointerDownHandler,IDragHandler,IMoveHandler
{
    public enum PICKCOLOR{ BODY,HAIR,EYE,UNDERWARE }

    public PICKCOLOR pickColor;
    Image mainImage;
    ...
    {
        if(pickColor==PICKCOLOR.BODY)
        {
            CursorPickSkin();
        }
        else if(pickColor == PICKCOLOR.EYE)
        {
            CursorPickEye();
        }
        else if (pickColor == PICKCOLOR.HAIR)
        {
            CursorPickHair();
        }
        else if (pickColor == PICKCOLOR.UNDERWARE)
        {
