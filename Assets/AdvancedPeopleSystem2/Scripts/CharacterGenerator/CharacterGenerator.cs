...
namespace AdvancedPeopleSystem
{
    public static class CharacterGenerator
    {
        public static void Generate(CharacterCustomization cc)
        {
            ...
            cc.SetBlendshapeValue(false, CharacterBlendShapeType.Fat, generatorSettings.fat.GetRandom());
            ...
            cc.SetBlendshapeValue(false, CharacterBlendShapeType.Head_Offset, headOffset);
            ...
            foreach (var fbs in generatorSettings.facialBlendshapes)
            {
                if (Enum.TryParse(fbs.name, out CharacterBlendShapeType faceShapeType))
                    cc.SetBlendshapeValue(false, faceShapeType, fbs.GetRandom());
            }
