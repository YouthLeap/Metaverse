...
namespace Photon.Chat.Demo
{
    ...
    public class ChatGui : MonoBehaviour, IChatClientListener
    {
        ...
        public void ChatInput(InputAction.CallbackContext context)
        {
            ...
            {
                Debug.Log("Came here 3");
                Debug.Log(eventSystem.currentSelectedGameObject);
                if (!InputFieldChat.isFocused && eventSystem.currentSelectedGameObject == null)
                {
                    Debug.Log("Came here 4");
                    Debug.Log("Isfocused");
                ...
                {
                    Debug.Log("Came here 5");
                    Debug.Log("notIsfocused");
        ...
        {
            //GameInputHandler.instance.gameInput.Chat.ChatPush.performed += ctx => ChatInput(ctx);
        }
        public void Start()
        {
            ...
            if(appIdPresent)
            {
                GetComponent<NamePickGui>().StartChat();
            }
        ...
        public void Update()
        {
            ...
            if ( this.StateText == null)
            {
                ...
                this.CurrentChannelText.text = allmassage;
        }
        ...
        private void SendChatMessage(string inputLine)
        {
            ...
            if (inputLine[0].Equals('\\'))
            {
                ...
                else if (tokens[0].Equals("\\msg") && !string.IsNullOrEmpty(tokens[1]))
                {
                    ...
                    Dictionary<string, object> msg = new Dictionary<string, object>() { { "ignoredKeyEg", true }, { "msg", message } };
                    this.chatClient.SendPrivateMessage(targetUser, msg);
                }
            ...
            else
            {
                if (doingPrivateChat)
                {
                    Dictionary<string, object> msg = new Dictionary<string, object>() { { "ignoredKeyEg", true }, { "msg", inputLine } };
                    
                    this.chatClient.SendPrivateMessage(privateChatTarget, msg);
                }
                else
                {
                    Dictionary<string, object> msg = new Dictionary<string, object>() { { "ignoredKeyEg", true }, { "msg", inputLine } };
                    this.chatClient.PublishMessage(this.selectedChannelName, msg);
                }
            }
        }
        ...
        public void OnSubscribed(string[] channels, bool[] results)
        {
            ...
            {
                Dictionary<string, object> msg = new Dictionary<string, object>() { { "ignoredKeyEg", true }, { "msg", "says 'hi'." } };
                this.chatClient.PublishMessage(channel, msg); // you don't HAVE to send a msg on join but you could.
        ...
        public static string allmassage = "";

        public void ShowChannel()
        {
            Debug.Log(allmassage);
            this.CurrentChannelText.text = allmassage+" asdasdasd";
        }
        public void ShowChannel(string channelName)
        {
            ...
            if(channel.ToStringLastMessages(GameManager.instance.mycontroller.playerName) !="" && GameManager.instance.mycontroller.playerlastMassage != channel.ToStringLastMessages(GameManager.instance.mycontroller.playerName))
            {
                GameManager.instance.mycontroller.playerlastMassage = channel.ToStringLastMessages(GameManager.instance.mycontroller.playerName);
                GameManager.instance.mycontroller.playerMassage = GameManager.instance.mycontroller.playerlastMassage;
                allmassage += GameManager.instance.mycontroller.playerlastMassage;
                AudioManager.instance.PlayMessageSend();
            }
            this.CurrentChannelText.text = allmassage;
            Debug.Log("ShowChannel: " + allmassage);
