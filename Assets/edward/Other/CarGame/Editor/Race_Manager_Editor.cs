...
[CustomEditor(typeof(EddyRaceManager))]
public class Race_Manager_Editor : Editor
{

    EddyRaceManager m_target;


    public void OnEnable()
    {
        m_target = (EddyRaceManager)target;
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        m_target._raceType = (EddyRaceManager.RaceType)EditorGUILayout.EnumPopup("Race Type", m_target._raceType);
        ...
        m_target._playerSpawnPosition = (EddyRaceManager.PlayerSpawnPosition)EditorGUILayout.EnumPopup("Player Spawn Position", m_target._playerSpawnPosition);
        if (m_target._playerSpawnPosition == EddyRaceManager.PlayerSpawnPosition.Selected)
        {
        ...
        GUILayout.Box("Spawn Settings", EditorStyles.boldLabel);
        m_target._aiSpawnType = (EddyRaceManager.AISpawnType)EditorGUILayout.EnumPopup("AI Spawn Type", m_target._aiSpawnType);
        if (m_target._aiSpawnType == EddyRaceManager.AISpawnType.Randomized)
        {
