...
namespace RGSK
{
    public class EddyRaceManager : MonoBehaviour
    {

        public static EddyRaceManager instance;

		GameObject TraficLight;
		GameObject Red;
		GameObject Yellow;
		GameObject Green;
...
//			}
        ...
        void Start()
        {
			...
			TraficLight = GameObject.Find ("LIGHT");
