...
namespace RGSK
{
    public class ReplayManager : MonoBehaviour
    {
        ...
        public void ViewReplay()
        {
            ...
            EddyRaceManager.instance.SwitchRaceState(EddyRaceManager.RaceState.Replay);
        ...
        {
            EddyRaceManager.instance.SwitchRaceState(EddyRaceManager.RaceState.Complete);
        ...
        private void DisableInputs()
        {
            for (int i = 0; i < racers.Count; i++)
            {
                EddyRaceManager.instance.DisableRacerInput(racers[i].racer.gameObject);
            }
        }
