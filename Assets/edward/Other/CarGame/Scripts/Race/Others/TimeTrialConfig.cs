...
namespace RGSK
{
    public class TimeTrialConfig : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            EddyRaceManager.instance.SwitchRaceState(EddyRaceManager.RaceState.Racing);
            CameraManager.instance.ActivatePlayerCamera();

            //Set AI to drive to the starting point
            if (EddyRaceManager.instance.timeTrialAutoDrive)
            {
        ...
        IEnumerator StartTimeTrial()
        {
            ...
            EddyRaceManager.instance.StartRace();
