...
namespace RGSK
{
    public class MenuManager : MonoBehaviour
    {
        ...
        public class MenuTrack
        {
            ...
            public Sprite image;
            public EddyRaceManager.RaceType raceType = EddyRaceManager.RaceType.Circuit;
...
//#endif
        ...
        public void AdjustRaceType(int val)
        {
            ...
            switch (raceTypeIndex)
            {
                ...
                case 1:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.Circuit;
                    break;

                case 2:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.LapKnockout;
                    break;

                case 3:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.TimeTrial;
                    break;

                case 4:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.SpeedTrap;
                    break;

                case 5:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.Checkpoints;
                    break;

                case 6:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.Elimination;
                    break;

                case 7:
                    menuTracks[trackIndex].raceType = EddyRaceManager.RaceType.Drift;
                    break;
            }
        ...
        public void AdjustLaps(int val)
        {
			...
			if (menuTracks [trackIndex].laps == 1) {
				menuTracks [trackIndex].laps = 3;
			} else if (menuTracks [trackIndex].laps == 3) {
				menuTracks [trackIndex].laps = 5;
			} else if (menuTracks [trackIndex].laps == 5) {
				menuTracks [trackIndex].laps = 25;
			} else if (menuTracks [trackIndex].laps == 25) {
				menuTracks [trackIndex].laps = 1;
			}
        ...
        public void AdjustAiDifficulty(int val)
        {
            ...
            aiDiffIndex += val;
            aiDiffIndex = Mathf.Clamp(aiDiffIndex, 1, 3);
